...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Utilizamos a Cloudia, IA especializada em saúde, integrada à API Oficial do WhatsApp (Meta). Estabilidade e entregabilidade garantidas.',
      },
    },
    {
      '@type': 'Question',
          ...
          <div className="faq-grid">
            ...
            >
              ...
              <p>
                ...
                entregabilidade garantidas pela API Oficial.
